...
--rounded to 2 decimal places. In other words, you need to count the number of players that logged 
--in for at least two consecutive days starting from their first login date,
